[![Build Status](https://travis-ci.com/diotoborg/itaque-incidunt-optio.svg?branch=main)](https://travis-ci.com/diotoborg/itaque-incidunt-optio)
...
[![Maintainability](https://api.codeclimate.com/v1/badges/31071476c2117e90d6fe/maintainability)](https://codeclimate.com/github/diotoborg/itaque-incidunt-optio/maintainability)
[![Test Coverage](https://api.codeclimate.com/v1/badges/31071476c2117e90d6fe/test_coverage)](https://codeclimate.com/github/diotoborg/itaque-incidunt-optio/test_coverage)
...
Install it using npm: `npm install @diotoborg/itaque-incidunt-optio`

If used in a browser environment, you will need to manually install the local you wish to support.

```javascript
var languages = require("@diotoborg/itaque-incidunt-optio");

// Support german & english languages.
languages.registerLocale(require("@diotoborg/itaque-incidunt-optio/langs/en.json"));
languages.registerLocale(require("@diotoborg/itaque-incidunt-optio/langs/de.json"));
```
